    ...
    public function getConfigTreeBuilder()
    {
        ...
        $rootNode
            ->children()
                ...
                ->scalarNode('http_port')->defaultValue('8082')->end()
                ->scalarNode('trusted_url')->defaultNull()->info('Internal URI that does not require authentication')->end()
            ...
            ->children()
                ...
                ->info('router configuration')
                    ->children()
                        ...
                        ->scalarNode('trusted_port')->defaultNull()->end()
